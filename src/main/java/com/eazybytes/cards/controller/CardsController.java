...
import com.eazybytes.cards.model.Properites;
...
public class CardsController {
	...
	public String getPropertyDetails() throws JsonProcessingException {
		...
		Properites properites = new Properites(cardsConfig.getMsg(), cardsConfig.getBuildVersion(), cardsConfig.getMailDetails(), cardsConfig.getActiveBranches());
